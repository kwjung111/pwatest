...
function isCapturingGroupAndNotZeroLength(element) {
    return element.type === "CapturingGroup" && !(0, regexp_ast_analysis_1.isZeroLength)(element);
}
function parsePatternElements(node) {
